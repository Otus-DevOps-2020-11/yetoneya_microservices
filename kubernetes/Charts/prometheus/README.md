...
server:
  ingress:
    ## If true, Prometheus server.yaml Ingress will be created
    ##
    enabled: true

    ## Prometheus server.yaml Ingress hostnames
    ## Must be provided if Ingress is enabled
    ##
    hosts:
      - prometheus.domain.com

    ## Prometheus server.yaml Ingress TLS configuration
    ## Secrets must be manually created in the namespace
    ##
    tls:
      - secretName: prometheus-server.yaml-tls
        hosts:
          - prometheus.domain.com
```
